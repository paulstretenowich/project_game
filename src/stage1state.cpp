...
//    SDL_GetRendererOutputSize(Game::m_pRenderer, &size.x, &size.y);
    ...
    background = TextureManager::LoadTextureImg("../images/background_story/001_BraveForest.png");
        ...
        switch (event.type)
        {
            ...
            case SDL_KEYUP:
                switch (event.key.keysym.sym)
                {
                    ...
                    case SDLK_SPACE:
                        if (Stage1State::text_selector < Stage1State::ChangeText().size()-1 && Stage1State::text_selector != 2 && Stage1State::text_selector != 3 && Stage1State::text_selector != 4)
                        {
                            Stage1State::text_selector += 1;
                        }
                        else if (Stage1State::text_selector == 4 || Stage1State::text_selector == 5)
                        {
...
void Stage1State::Draw(Game* game)
{
    ...
    if (Stage1State::text_selector == 4 || Stage1State::text_selector == 5)
    {
    ...
    else
    {
        ...
        aragorn_dest.x = background_dest.w*1/8 - aragorn_dest.h/2;
    ...
    if (Stage1State::text_selector == 2 || Stage1State::text_selector == 3)
    {
